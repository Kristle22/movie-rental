...
Movie-rental server project

# Public domain site design:

![movies](./server/img/movies_public.png)

# Administrative domain site design:

![movies](./server/img/movies_create.png)
![movies](./server/img/movies_modal.png)
![movies](./server/img/movies_cats.png)
![movies](./server/img/movies_coms.png)
